...
def time_ago(time1, time2):
    time_limit = 0
    time_ago = ""
    if time1.year - time2.year != 0:
        time_ago += "{} Year{} ".format(time1.year - time2.year, determine_plural(time1.year - time2.year))
        time_limit = time_limit + 1
    if time1.month - time2.month != 0:
        time_ago += "{} Month{} ".format(time1.month - time2.month, determine_plural(time1.month - time2.month))
        time_limit = time_limit + 1
    if time1.day - time2.day != 0 and not time_limit == 2:
        time_ago += "{} Day{} ".format(time1.day - time2.day, determine_plural(time1.day - time2.day))
        time_limit = time_limit + 1
    if time1.hour - time2.hour != 0 and not time_limit == 2:
        time_ago += "{} Hour{} ".format(time1.hour - time2.hour, determine_plural(time1.hour - time2.hour))
        time_limit = time_limit + 1
    if time1.minute - time2.minute != 0 and not time_limit == 2:
        time_ago += "{} Minute{} ".format(time1.minute - time2.minute, determine_plural(time1.minute - time2.minute))
        time_limit = time_limit + 1
    if not time_limit == 2:
        time_ago += "{} Second{} ".format(time1.second - time2.second, determine_plural(time1.second - time2.second))
    return time_ago
